...
class ModelArguments:
    ...
    use_auth_token: bool = field(
        default=None,
        metadata={"help": "The `use_auth_token` argument is deprecated and will be removed in v4.34. Please use `token` instead."},
    )
...
def main():
    ...
    model_args, data_args, training_args = parser.parse_json_file(json_file="hf_config.json")
